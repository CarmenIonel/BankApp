...
<body>
<div id="content">
<form name="/createClientAccount" action="/createClientAccount" method='POST'>
    <h1>Create</h1>
        ...
        <p>
            ...
            <input type="email" name="email" id="email" 	placeholder="eg: ionel.carmen@yahoo.com" required/>
        </p>

		<p>
            <label for="phone" class="phone"> Phone</label>
            <input type="text" name="phone" id="phone" 		placeholder="07xxxxxxxx" required pattern="[07][0-9]{9}"/>
        </p>

        <p>
            <label for="card" class="card"> Card Number</label>
            <input type="text" name="card" id="card" placeholder="Card Number" required/>
        </p>

        <p>
            <label for="suma" class="suma"> Sum</label>
            <input type="text" name="suma" id="suma" placeholder="Sum" pattern="[0-9]*(\.)?[0-9]+" required/>
        </p>
        <p>
