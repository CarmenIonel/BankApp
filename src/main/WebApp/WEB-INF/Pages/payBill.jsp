...
<body>
<div id="content">
<form name="/payBill" action="/payBill" method='POST'>
    <h1>Pay Bill</h1>
        <p>
            <label for="idb" class="idb">ID Bill
            </label>
            <input type="text" name="idb" id="idb" 	placeholder="ID Bill" required/>
        </p>
        <p>
            <label for="idc" class="idcl">ID Client
            </label>
            <input type="text" name="idc" id="idc" 	placeholder="ID Client" required/>
        </p>
        <p>
            <label for="sum" class="sum">Sum
            </label>
            <input type="text" name="sum" id="sum" 	 placeholder="Sum" required pattern="[0-9]*(\.)?[0-9]+" />
        </p>
        <p>
        <button input type="submit">Pay</button>
   	</p>
</form>
</div>
</body>
