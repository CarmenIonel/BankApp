...
<body>
<div id="content">
<form name="/viwAccount" action="/viewAccount" modelAttribute="account" method='POST'>
    <h1>View Account</h1>

        <p>
                    <label for="id" class="id"> ID
                    </label>
                    <input type="text" name="id" id="id"  placeholder="Search field" required />
         </p>

        <p>
            <label for="suma" class="suma"> Suma
            </label>
            <c:out value="${account.sumAcc}"/>
        </p>

        <p>
            <label for="card" class="card">Card Number
            </label>
            <c:out value="${account.cardNumber}"/>
        </p>

        <p>
            <label for="data" class="data"> Data creation</label>
            <c:out value="${account.dataCreation}"/>
        </p>
        <p>
                        <button input type="submit">
                        <a href="/adminMeniu">Back</a></button>
         </p>
</form>
</div>
</body>
