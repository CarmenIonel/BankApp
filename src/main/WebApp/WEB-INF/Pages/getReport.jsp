...
<body>
<div id="content">
<form name="/getReport" action="/getReport" modelAttribute="report" method='POST'>
   <h1>Get Report</h1>
        ...
        <c:forEach var="listValue" items="${report}">
         <tr>
               <td>
                    <c:out value="${listValue.data}" />
              </td>
               <td>
                    <c:out value="${listValue.record}" />
               </td>
                </tr>
         </c:forEach>
           </table>
