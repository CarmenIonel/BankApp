...
<div id="content">
    ...
    <p>
        ...
        <a href="/createEmployee">Create </a></button>
   	</p>

    <p>
        <button input type="submit">
        <a href="/viewEmployee">View</a></button>
   	</p>

    <p>
        <button input type="submit">
        <a href="/updateEmployee">Update</a></button>
   	</p>


    <p>
        <button input type="submit">
        <a href="/deleteEmployee">Delete</a></button>
   	</p>

    <p>
        <button input type="submit">
        <a href="/getReport">Generate Report</a></button>
   	</p>
